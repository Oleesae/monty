...
- Stack, Queues and when to use them
- Common implementations of stacks and queues
- Common uses of stacks and queues
- Proper ways to use global variables (extern)
...
### Contributors.
- Ezra Christopher Mallo - ezra.mallo@gmail.com
